...
public class ElasticSearchUtil {
     ...
     * @return
     */
    public static EsPageUtil searchDataPage(String index, String type, int startPage, int pageSize, QueryBuilder query, String fields, String sortField, String highlightField) {
        ...
        if (searchResponse.status().getStatus() == 200) {
            ...
            return new EsPageUtil(startPage, pageSize, (int) totalHits, sourceList);
        }
